...
export const mockedProyectsNode: MockedProyects[] = [
    {
        ...
        technologies_img_url: ['node-js.svg','express-js.svg','jwt.svg','postgresql.svg','zod.svg'],
    ...
    },
    {
        ...
        technologies_img_url: ['express-js.svg','angular.svg','prisma.svg','typescript.svg'],
...
export const mockedProyectsLaravel: MockedProyects[] = [
    ...
    },
    {
        ...
        image: 'not-found.jpeg',
        technologies: ['Laravel', 'Laravel-Permission', 'Mysql', 'Tailwindcss'],
        technologies_img_url: ['laravel.svg','mysql.svg','tailwindcss.svg'],
